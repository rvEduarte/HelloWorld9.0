...
public class TrialDragPH2TWO : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (eventData.pointerEnter == null || eventData.pointerEnter.GetComponent<TrialDropPh2TWO>() == null)
        {
