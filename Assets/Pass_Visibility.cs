...
public class Pass_Visibility : MonoBehaviour
{
    [SerializeField]private TMP_InputField passwordTMPInputField;  // TextMeshPro InputField
    [SerializeField]private Button toggleButton;  // Button to toggle password visibility
    [SerializeField]private GameObject eyeClosedImage;  // Image for closed eye (password hidden)
    [SerializeField]private GameObject eyeOpenImage;  // Image for open eye (password visible)
