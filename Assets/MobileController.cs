...
public class MobileController : MonoBehaviour, MobilePlayerController
{
    [SerializeField] private MobileScriptable _stats;
    private Rigidbody2D _rb;
    private CapsuleCollider2D _col;
    private MobileFrameInput _frameInput;
    ...
    private void GatherInput()
    {
        ...
        {
            _frameInput = new MobileFrameInput();  // Zero out input when movement is disabled
            return;
        }
...
public struct MobileFrameInput
{
...
public interface MobilePlayerController
{
    public event Action<bool, float> GroundedChanged;
