...
public class JumpDragScript : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (eventData.pointerEnter == null || eventData.pointerEnter.GetComponent<ThirdSlotScript>() == null && eventData.pointerEnter.GetComponent<Row2ThirdSlotScript>() == null && eventData.pointerEnter.GetComponent<Row3ThirdSlotScript>() == null)
        {
