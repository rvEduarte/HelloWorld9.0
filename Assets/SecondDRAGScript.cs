...
public class SecondDRAGScript : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (eventData.pointerEnter == null || eventData.pointerEnter.GetComponent<SecondSlotScript>() == null && eventData.pointerEnter.GetComponent<Row2SecondSlotScript>() == null)
        {
