...
[CreateAssetMenu(fileName = "LeaderboardPersistentDataScriptable", menuName = "ScriptableObjects/LeaderboardPersistentDataScriptable")]
public class LeaderboardPersistentDataScriptable : ScriptableObject
{
    ...
    {
        filePath = Path.Combine(Application.persistentDataPath, "offlinePersistentScoreData.json");
