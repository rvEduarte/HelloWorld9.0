...
public class TrialDragTHREE : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (eventData.pointerEnter == null || eventData.pointerEnter.GetComponent<TrialDropTHREE>() == null)
        {
